  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-3 text-green-400">
        ...
        <div>
          <p className="font-medium">Secret created successfully!</p>
          <p className="text-sm text-gray-400">Share the link below</p>
        </div>
      </div>
      ...
      <div className="space-y-2">
        <div className="flex items-start gap-3 text-sm text-amber-400/80 bg-amber-500/10 border border-amber-500/20 rounded-lg p-3">
          ...
          <div>
            ...
            <p className="text-amber-400/60">This link will work only once. After viewing, the secret is permanently destroyed.</p>
          </div>
        </div>
